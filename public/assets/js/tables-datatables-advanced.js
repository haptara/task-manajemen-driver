$(function() {
    ...
    function l(t, a) {
        var e, l, s, o, r;
        5 == t ? (e = d.val(), l = c.val(), "" !== e && "" !== l && ($.fn.dataTableExt.afnFiltering.length = 0, n.dataTable().fnDraw(), s = t, o = e, r = l, $.fn.dataTableExt.afnFiltering.push(function(t, a, e) {
            var a = i(a[s]),
                l = i(o),
                n = i(r);
    ...
    s.length && s.flatpickr({
        ...
        onClose: function(t, a, e) {
            var l;
            new Date;
            null != t[0] && (l = moment(t[0]).format("MM/DD/YYYY"), d.val(l)), null != t[1] && (l = moment(t[1]).format("MM/DD/YYYY"), c.val(l)), $(s).trigger("change").trigger("keyup")
        }
